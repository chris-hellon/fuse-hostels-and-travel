...
using FuseHostelsAndTravel.Core.Models;

namespace FuseHostelsAndTravel.Core.Data
{
    public class ApplicationUserManager<T> : UserManager<ApplicationUser>
    {
        private readonly UserStore<ApplicationUser, ApplicationRole, ApplicationDbContext, string, IdentityUserClaim<string>,
            ApplicationUserRole, IdentityUserLogin<string>, ApplicationUserToken, ApplicationRoleClaim> _store;
            ...
            : base(store, optionsAccessor, passwordHasher, userValidators, passwordValidators, keyNormalizer, errors, services, logger)
        {
            _store = (UserStore<ApplicationUser, ApplicationRole, ApplicationDbContext, string, IdentityUserClaim<string>,
                ApplicationUserRole, IdentityUserLogin<string>, ApplicationUserToken, ApplicationRoleClaim>)store;
        }
